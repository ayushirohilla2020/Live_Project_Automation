...
public class SameDepartueArrival {


	@Test
	public void ShouldNot_BookFlight_With_SameDepartureAndArrival() throws IOException {
		
		Properties prop1 = new Properties();
		FileInputStream fis = null;
		try {
			fis = new FileInputStream("/home/ayushi/eclipse-workspace/BootCamp-LiveProjectAssignment/SeleniumSession/src/liveProject/data.properties");
...
//		String ArrivingIn = prop1.getProperty("ArrivingIn");
		...
		driver.findElement(By.name("passFirst0")).sendKeys("Ayushi");
		driver.findElement(By.name("passLast0")).sendKeys("Rohilla");
		...
		driver.findElement(By.name("cc_frst_name")).sendKeys("Ayushi");
		driver.findElement(By.name("cc_mid_name")).sendKeys("");
		driver.findElement(By.name("cc_last_name")).sendKeys("Rohilla");
